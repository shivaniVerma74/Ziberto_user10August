...
final Uri getBuyOneSellerApi = Uri.parse(baseUrl + 'get_biy_get_free');
final Uri getBuyOneApi = Uri.parse(baseUrl + 'get_buy_one_get_one_free_seller');
...
final Uri getFreeSubCatBySellerId = Uri.parse(baseUrl + 'sub_cat_free');
final Uri getWeeklyOfferApi = Uri.parse(baseUrl + 'get_weekend');
final Uri getWeeklySellerApi = Uri.parse(baseUrl + 'get_weekend_seller');
...
const String PACKIMG_CHARGE = 'packing_charge';
...
const String PAC_CHARGE = 'packing_charge';
