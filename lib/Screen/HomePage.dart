...
import 'package:eshop_multivendor/Screen/Weekly_Offer_SellerList.dart';
...
class _HomePageState extends State<HomePage>
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // _section(),
                    weekOffer(),
                    CUR_USERID != null ? buyOneGetOneOffer() : Container(),
                    _seller(),

                    // ElevatedButton(onPressed: (){
                    //   Navigator.push(context, MaterialPageRoute(builder: (context) => FreeFoodPage()));
    ...
    return GestureDetector(
      ...
      onTap: () async {
        ...
        if (homeSliderList[curSlider].type == "products") {
          ...
          print("this is seller ID ${item?.seller_id}");
          Navigator.push(
            context,
                    ...
                    children: [
                      sellerList.isNotEmpty
                          ? ListTile(
                              ...
                              //     }),
                              title: Text(
                                  getTranslated(context, 'RES_BY_SELLER')!,
                                  style: TextStyle(
                                      color: Theme.of(context)
                                          .colorScheme
                                          .fontColor,
                                      fontWeight: FontWeight.bold)),
                              // subtitle:foodType? Text("Non Veg" , style: TextStyle(
                              //   color: Colors.red
                                                    ...
                                                    children: [
                                                      ListTile(
                                                        ...
                                                        subtitle: Text(
                                                         ...
                                                         // \n${sellerList[index].open_close_status}
                                                          maxLines: 2,
                                                        ),
                                                        trailing: Text(
                                                          sellerList[index]
  ...
  void getWeeklyOffer() async {
    var param = {};
    apiBaseHelper.postAPICall(getWeeklyOfferApi, param).then((value) {
      print(value);
      setState(() {
        weekOfferData = value["date"];
      });
    });
  }

  Widget weekOffer() {
    return weekOfferData.isNotEmpty
        ? Column(
      children: [
        ListTile(
          title:
          Text("${weekOfferData[0]["week"]} Offers For You :-)"),
        ),
        InkWell(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => WeeklyOfferSellerList(
                    catId : catList[0].id,
                      weekName: weekOfferData[0]["week"]),
                ));
          },
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      fit: BoxFit.fill,
                      image: NetworkImage(
                          "$imageUrl${weekOfferData[0]["image"]}"))),
            ),
          )
        ),
      ],
    )
        : Container(child: Text('No Offer Available'),);
  }

  Widget buyOneGetOneOffer(){
    return Column(
      children: [
        ListTile(
          title: Text("Buy One Get One Offer"),
        ),
        InkWell(
            onTap: () {
              Navigator.push(context,
            ...
            child: Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.fill,
                        image: AssetImage("assets/images/free-food.jpg")
                    )),
              ),
            )
        ),
