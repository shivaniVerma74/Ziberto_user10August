...
class ProductDetail extends StatefulWidget {
  ...
  ProductDetail({Key? key, this.sellerId, this.model, this.secPos, this.index, this.list,  this.freePro})
      : super(key: key);
  ...
  removeFromCart() async {
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null) {
        ...
        apiBaseHelper.postAPICall(manageCartApi, parameter).then((getdata) async {
          bool error = getdata["error"];
          String? msg = getdata["message"];
          if (!error) {
                ...
                Column(
                  ...
                  children: [
                    ...
                    widget.model!.attributeList!.isNotEmpty
                        ? Divider()
                        : Container(),
                    widget.model!.packing_charge!=""?_packingCharge():Container(),
                    _madeIn(),
                    _warrenty(),
                    _gaurantee(),
          ...
          delegate: SliverChildListDelegate([
            ...
            Column(
              ...
              children: <Widget>[
                ...
                productList.length > 0 && widget.freePro == false
                    ? Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                ...
                Container(
                    ...
                    child: NotificationListener<ScrollNotification>(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return
                              (index == productList.length &&
                                ...
                                ? simmerSingle()
                                :
                          widget.model!.name != productList[index].name ? productItem(index) : Container() ;
                            // :  index == 0 ?
                            // Card(
                            //   elevation: 0,
                            //   child: Column(
                            ...
                            : !notificationisloadmore ? simmerSingle() : Container()
                        // Container(
                        //   child: Card(
                        //     child: Column(
                        //       mainAxisSize: MainAxisSize.min,
                        ...
                        //               start: 5.0, top: 5, bottom: 5),
                        //           child: Text(
                        //             "${productList[0].shortDescription}",
                        //             style: TextStyle(
                        //                 color: Theme.of(context).colorScheme.fontColor,
                        //                 fontWeight: FontWeight.bold),
                        //             maxLines: 1,
                        ...
                        //                   ? CUR_CURRENCY! +
                        //                   "" +
                        //                   productList[0].prVarientList![0].price!
                        //                   : "",
    ...
    if (_isNetworkAvail) {
      try {
        if (notificationisloadmore) {
          ...
          if(widget.freePro == true){
            parameter["free_pro_id"] = widget.model.freeProductId;
            parameter["buy_one"] = "1";
          }
