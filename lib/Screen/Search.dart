...
class _SearchState extends State<Search> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller.addListener(() {
      if (_controller.text.isEmpty) {
        ...
        query = resText;
        print("----$resText ${_controller.text}");
        notificationoffset = 0;
        notificationisnodata = false;
        buildResult = false;
  ...
  _showContent() {
    ...
    return notificationisnodata
        // ? getNoItem(context)
        ?  getNoItem(context)
    // Center(child: Container(child: Text("No Items found..",
                    ...
                    child: ListTile(
                      onTap: () {
                        if (CUR_USERID == null) {
                          ...
                          try {
                            if (sellerLists[index]["open_close_status"] ==
                                "1") {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int i) {
        ...
        print("suggest list here ${suggestion.name}");
        return ListTile(
            title: Text(
              suggestion.name!,
              style: Theme.of(context).textTheme.subtitle2!.copyWith(
