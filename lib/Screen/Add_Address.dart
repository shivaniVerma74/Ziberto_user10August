      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            //   if (emailC!.text.isNotEmpty) {
            //     print(value);
            //     var validemailadat = value!.contains('@');
            //     var isEmaildort = value.contains('.');
            //     if (validemailadat == true && isEmaildort == true) {
            //       var newvale = value.length;
            //       var lveleded = value[newvale - 1].contains(RegExp(r'[a-z]'));
            //       if (lveleded == true) {
            //         return null;
            //       } else {
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        addressC!.text = "${placemark[0].street} ,${placemark[0].locality}, ${placemark[0].subLocality} , ${placemark[0].administrativeArea}";
